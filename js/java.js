(() => {
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".slider-main__body") &&
      new de(".slider-main__body", {
        modules: [pe, he, ge],
        observer: !0,
        observeParents: !0,
        slidesPerView: 1,
      ...
      document.querySelector(".slider-tips__body") &&
        new de(".slider-tips__body", {
          ...
          breakpoints: {
            320: { slidesPerView: 1.1, spaceBetween: 15, autoHeight: !0 },
    ...
    Ze = (function () {
      ...
      return (
          ...
          if (!(this.$container && this.$container.get())) {
            ...
            var n = this.settings.ariaLabelledby
              ...
              d =
                ...
                "\n                </div>\n            </div>\n        </div>\n        ";
            Ge(this.settings.container).append(d),
              document.body !== this.settings.container &&
                Ge(this.settings.container).css("position", "relative"),
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(Ee, { index: t, delay: s || 0, isFirstSlide: n });
          }, a);
        }),
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger($e), Ge(window).scrollTop(this.prevScrollTop);
          var s,
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        i.classList.contains("products__more") &&
          (getProducts(i), e.preventDefault());
      ...
      async function i(e, t) {
        if (0 === (e.hasAttribute("data-no-validate") ? 0 : c.getErrors(e))) {
          if (e.hasAttribute("data-ajax")) {
            ...
            const o = await fetch(s, { method: i, body: r });
            if (o.ok) {
              await o.json();
          ...
          s && e.hasAttribute("data-goto-error") && d(s, !0, 1e3);
        }
      }
      function n(t) {
        document.dispatchEvent(
